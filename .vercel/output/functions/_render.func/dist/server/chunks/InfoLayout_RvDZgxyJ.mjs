import { c as createComponent, b as createAstro, m as maybeRenderHead, d as addAttribute, r as renderSlot, a as renderTemplate, e as renderComponent } from './astro/server_nJrU_vTu.mjs';
import { $ as $$RootLayout } from './RootLayout_boNY-ri8.mjs';
...
}, "/home/inarty/Portfolio/astro/Raghvendra712.github.io/src/components/external-link.astro", void 0);
...
const $$InfoLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.url.pathname;
  return renderTemplate`${renderComponent($$result, "RootLayout", $$RootLayout, { "title": title, "description": description }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex relative gap-4 w-full"> <!-- <nav class="relative w-4 md:min-w-2xs xl:min-w-sm sm:min-h-screen sm:ml-4 sm:pb-4">
		...
		</nav> --> <main> ${renderSlot($$result2, $$slots["default"])} ${renderComponent($$result2, "Footer", $$Footer, {})} </main> </div> ` })}`;
}, "/home/inarty/Portfolio/astro/Raghvendra712.github.io/src/layouts/InfoLayout.astro", void 0);

export { $$InfoLayout as $ };
